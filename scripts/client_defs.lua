...
table.insert( cdefs.ALL_KEYBINDINGS, { name = "UITR_ONECELLVISION", txt = STRINGS.UITWEAKSR.UI.OPTIONS_KEYBIND_ONECELLVISION, defaultBinding = mui_util.makeBinding( mui_defs.K_Z ) } )
