local UI_TWEAKS_STRINGS = {
    ...
    UI = {
        ...
        BTN_GLOBAL_PATHS_HEADER = "GUARD PATHS",
        BTN_GLOBAL_PATHS_ON_TXT = "Visible.\nClick to hide.",
        BTN_GLOBAL_PATHS_OFF_TXT = "Hidden.\nClick to show.",
        BTN_GLOBAL_TRACKS_HEADER = "GUARD FOOTPRINTS",
        BTN_GLOBAL_TRACKS_ON_TXT = "Visible.\nClick to hide.",
        BTN_GLOBAL_TRACKS_OFF_TXT = "Hidden.\nClick to show.",
        BTN_GLOBAL_TRACKS_E_ON_TXT = "Visible.\nClick to hide until enemy turn.",
        BTN_GLOBAL_TRACKS_E_OFF_TXT = "Hidden until enemy turn.\nClick to show.",
